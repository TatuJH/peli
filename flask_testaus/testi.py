...
achievements = {
    "distance":[
        (10000, "First Steps", "For travelling 10000 km", 50),
        (30000, "Beginner Traveler", "For travelling 30000 km", 75),
        (60000, "Intermediate Traveler", "For travelling 60000 km", 100),
        (80000, "Advanced Traveler", "For travelling 80000 km", 150),
        (125000, "Master Traveler", "For travelling 125000 km", 300),
        (175000, "Business Class", "For travelling 175000 km", 400),
        (200000, "First Class", "For travelling 200000 km", 500),
        (250000, "Apostle", "For travelling 250000 km", 500),
        (9999999999999999999999, "error", "error", 999999999999)
    ],
    "countries":[
        (3, "Sightseer", "For visiting 4 countries", 75),
        (6, "Tourist", "For visiting 6 countries", 100),
        (10, "Regular", "For visiting 10 countries", 150),
        (13, "Dual Citizenship", "For visiting 13 countries", 200),
        (18, "Missionary", "For visiting 18 countries", 350),
        (9999999999999999999999, "error", "error", 9999999999)
    ],
    "money":[
        (300, "Intern", "For earning $300", 50),
        (600, "Hard Worker", "For earning $600", 100),
        (1200, "Businessman", "For earning $1200", 150),
        (2000, "CEO", "For earning $2000", 200),
        (3000, "Tithe", "For earning $3000", 300),
        (4000, "Peter's Pence", "For earning $4000", 300),
        (99999999999999999999999999, "error", "error", 9999999999999999)
    ],
    "artefacts":[
        (1, "Explorer", "For finding your first artefact", 50),
        (3, "Treasure Hunter", "For finding 3 artefacts", 100),
        (8, "Culture Preserver", "For finding 8 artefacts", 150),
        (12, "Indiana Jones", "For finding 12 artefacts", 200),
        (9999999999999999999999, "error", "error", 9999999999999)
    ],
    "events":[
        (3, "Risk-taker", "For completing 2 events", 75),
        (6, "Lucky Guy", "For completing 6 events", 125),
        (10, "True Adventurer", "For completing 10 events", 150),
        (16, "Fortuna", "For completing 16 events", 300),
        (999999999999999999999, "error", "error", 9999999999999)
    ],
    "convert":[
        (1, "Believer", "For converting heretics once", 100),
        (2, "Faithful", "For converting heretics 2 times", 150),
        (4, "Devotee", "For converting heretics 4 times", 200),
        (7, "Chosen One", "For converting heretics 7 times", 300),
        (10, "Mandate from Heaven", "For converting heretics 10 times", 400),
